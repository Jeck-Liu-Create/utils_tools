...
def zy_db_query():
    q_sql = r"select id,支付金额,创单日期,标志 from %s where 差值 != 0 limit 1" % (db_name_zy)
...
def main_other():
    ...
    first_data_zy_date = first_data_zy[0]["创单日期"]
